...
class _$MainImpl implements _Main {
  _$MainImpl({this.latitude, this.longitude});
  ...
  @override
  String toString() {
    return 'Main(latitude: $latitude, longitude: $longitude)';
  }
...
abstract class _Main implements Main {
  factory _Main({final double? latitude, final double? longitude}) = _$MainImpl;
